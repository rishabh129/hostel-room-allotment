...
const NewApplication = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    await firebase.handleNewRoomApplicationSubmit(
      formData,
      userPhoto,
      admissionSlip,
      feeReceipt
            ...
            <form onSubmit={handleSubmit} method>
              ...
              <fieldset className="academic-info-section">
                ...
                >
                  ...
                  <option value="ds">
                    Centre for Quantitative Analysis and Data Science
                  </option>
                  <option value="eee">
              ...
              <fieldset className="documents-section">
                ...
                <label htmlFor="photo-upload" id="photo">
                  Photo:
                </label>
                <input
                  type="file"
                ...
                />{" "}
                <br />
                <label id="slip" htmlFor="admission-slip-upload">
                  Admission Slip:
                </label>
                <input
                  type="file"
                  id="admission-slip-upload"
                  name="admissionSlip"
                  onChange={(e) => setAdmissionSlip(e.target.files[0])}
                />{" "}
                <br />
                <label id="fee" htmlFor="fee-slip-upload">
                  Fee Slip:
                </label>
                <input
                  type="file"
